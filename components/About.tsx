        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-violet-200/70 mb-8 leading-relaxed">
              Mais de 50 marcas depois, de influencers com milhões de seguidores a healthtechs e incorporadoras, virou o Método CTR. Não é fórmula mágica. É a sequência certa para não desperdiçar o que você já tem.
            </p>
